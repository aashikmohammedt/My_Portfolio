...
function Portfolio() {
  ...
  return (
    <section id="projects" className="py-28 max-w-[1460px] mx-auto px-6">
      <motion.p
        ...
        <AnimatePresence>
          {filtered.map((project) => (
            <motion.button
              ...
              className="group text-left rounded-3xl overflow-hidden bg-butter"
            >
        ...
        {active && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-paper rounded-3xl max-w-xl w-full overflow-hidden"
            >
              ...
              <button
                onClick={() => setActive(null)}
                aria-label="Close"
                className="absolute top-4 right-4 inline-flex items-center justify-center w-10 h-10 rounded-full bg-paper hover:bg-ink hover:text-paper transition-colors"
              >
                <X size={18} />
              </button>
